...
- Score count was not functioning as intended. Score count was doubling, I noticed that I had left score++ in my setAnswerColor function along with another score++ in my correctAnswer function. This was resolved by removing score++ from the setAnswer function.
...
Stack Overflow was referred to on numerous occasions during the development of this project. It was a useful resource for finding out how functions and javaScript worked in general. Code was used from the site in the following instances.
